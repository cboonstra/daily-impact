...
const SDGS = [
  ...
  // Placeholders for the rest until uploaded
  { id: 5, title: 'Gendergelijkheid', color: '#FF3A21', description: 'Bereik gendergelijkheid en empowerment voor alle vrouwen en meisjes.' },
  { id: 6, title: 'Schoon water en sanitair', color: '#26BDE2', description: 'Verzeker toegang tot duurzaam beheer van water en sanitair voor iedereen.' },
  { id: 7, title: 'Betaalbare en duurzame energie', color: '#FCC30B', description: 'Verzeker toegang tot betaalbare, betrouwbare, duurzame en moderne energie voor iedereen.' },
  { id: 8, title: 'Waardig werk en economische groei', color: '#A21942', description: 'Bevorder aanhoudende, inclusieve en duurzame economische groei, volledige en productieve tewerkstelling en waardig werk voor iedereen.' },
  { id: 9, title: 'Industrie, innovatie en infrastructuur', color: '#FD6925', description: 'Bouw veerkrachtige infrastructuur, bevorder inclusieve en duurzame industrialisering en stimuleer innovatie.' },
  { id: 10, title: 'Ongelijkheid verminderen', color: '#DD1367', description: 'Dring ongelijkheid in en tussen landen terug.' },
  { id: 11, title: 'Duurzame steden en gemeenschappen', color: '#FD9D24', description: 'Maak steden en menselijke nederzettingen inclusief, veilig, veerkrachtig en duurzaam.' },
  { id: 12, title: 'Verantwoorde consumptie en productie', color: '#BF8B2E', description: 'Verzeker duurzame consumptie- en productiepatronen.' },
  { id: 13, title: 'Klimaatactie', color: '#3F7E44', description: 'Neem dringend actie om klimaatverandering en haar impact te bestrijden.' },
  { id: 14, title: 'Leven in het water', color: '#0A97D9', description: 'Behoud en maak duurzaam gebruik van de oceanen, zeeën en maritieme hulpbronnen.' },
  { id: 15, title: 'Leven op het land', color: '#56C02B', description: 'Bescherm, herstel en bevorder het duurzaam gebruik van ecosystemen op het vasteland.' },
  { id: 16, title: 'Vrede, justitie en sterke instellingen', color: '#00689D', description: 'Bevorder vreedzame en inclusieve samenlevingen met het oog op duurzame ontwikkeling.' },
  { id: 17, title: 'Partnerschap om doelstellingen te bereiken', color: '#19486A', description: 'Versterk de implementatiemiddelen en revitaliseer het wereldwijd partnerschap voor duurzame ontwikkeling.' },
];
